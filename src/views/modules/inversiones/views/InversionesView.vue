<script setup>
      ...
      const openCreateModal = () => {
        ...
        inversionToEdit.value = {
          id: null,
          cuentaId: null,
          tipo: tiposInversion.value.length > 0 ? tiposInversion.value[0].value : 'credito',
          descripcion: '',
          beneficiario: '',
          monto: 0,
          interes: 0,
          ...
          fechaVencimiento: '',
          status: 'activo' // Cambiar de 'estado' a 'status' para coincidir con el backend
        };
      ...
      <template>
        <div class="space-y-6">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr v-for="inversion in inversionesFiltradas" :key="inversion.id">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ inversion.investment_name || inversion.descripcion }}</div>
          ...
          <InversionModal v-model:visible="showModal" :is-edit-mode="isEditMode" :inversion-data="inversionToEdit"
                          :tipos-inversion="tiposInversion" @save="handleSaveInversion"/>
        </div>
      </template>