    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tr>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercas">ID</th>
...
const {deleteInversion, addInversion, updateInversion, fetchInversiones} = store;
