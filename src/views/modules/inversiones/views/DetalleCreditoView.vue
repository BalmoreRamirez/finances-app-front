          ...
          const guardarPago = async () => {
            ...
            try {
              ...
              if (success) {
                ...
                toast.add({severity: 'error', summary: 'Error al registrar pago', detail: 'No se pudo registrar el pago', life: 3000});
              }
            } catch (error) {
              toast.add({severity: 'error', summary: 'Error al registrar pago', detail: 'No se pudo registrar el pago', life: 3000});
            }
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-gray-100 p-4 rounded-lg">
                      ...
                      <p class="text-2xl font-semibold text-blue-600">{{ formatCurrency(parseFloat(credito.invested_amount || credito.monto || 0)) }}</p>
                    </div>
                    <div class="bg-gray-100 p-4 rounded-lg">
                      <p class="text-sm text-gray-500">Interés</p>
                      <p class="text-2xl font-semibold text-green-600">{{ parseFloat(credito.interest || credito.interes || 0) }}%</p>
                    </div>
                    <div class="bg-gray-100 p-4 rounded-lg">
                      <p class="text-sm text-gray-500">Monto Total a Recibir</p>
                      <p class="text-2xl font-semibold text-gray-800">{{ formatCurrency(parseFloat(credito.total_amount || credito.montoTotal || 0)) }}</p>
                    </div>
                  </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div class="mb-6">
                    <div class="flex justify-between text-sm mb-1">
                      ...
                      <span class="font-bold text-gray-800">{{ formatCurrency(totalPagado) }} / {{ formatCurrency(parseFloat(credito.total_amount || credito.montoTotal || 0)) }}</span>
                    </div>
